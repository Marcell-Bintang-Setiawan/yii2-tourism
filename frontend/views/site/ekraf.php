...
$this->title = 'Ekonomi Kreatif - Explore Sda.';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="site-ekraf">
    <h1>Yuk, Beli Kreatif Lokal</h1>
            ...
            <div class="col-md-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Lokasi : <?= $r['lokasi'] ?></p>
                        <p class="card-text">Harga : <?= $r['harga'] ?></p>
                        <a href="<?= Url::toRoute(['site/viewekraf', 'id' => $r['id']]) ?>" class="btn btn-primary">Lihat</a>
                    </div>
